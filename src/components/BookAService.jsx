                ...
                <Row>
                    <Col sm={3}>
                        <Nav variant="tabs" className="flex-column">
                            <Nav.Item className={"navItem"}><Nav.Link eventKey="selectService" disabled={activeKey === "selectService" ? false : true}>Select service</Nav.Link></Nav.Item>
                            <Nav.Item className={"navItem"}><Nav.Link eventKey="dateTime" disabled={activeKey === "dateTime" ? false : true}>Date/Time</Nav.Link></Nav.Item>
                            <Nav.Item className={"navItem"}><Nav.Link eventKey="payment" disabled={activeKey === "payment" ? false : true}>Payment</Nav.Link></Nav.Item>
                            <Nav.Item className={"navItem"}><Nav.Link eventKey="bookIt" disabled={activeKey === "bookIt" ? false : true}>Book it</Nav.Link></Nav.Item>
                        </Nav>
                    </Col>
                    <Col sm={9}>
                        <Tab.Content>
